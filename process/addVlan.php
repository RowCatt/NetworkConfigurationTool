...
if(isset($_POST["id"]) && $_POST["id"] != "" && isset($_POST["name"]) && $_POST["name"] != ""){
    ...
    header("Location: ../vlanManagement.php.php?error=Fields left empty.");
    exit;
}

// Error if id is 1
if($id == 1){
    header("Location: ../vlanManagement.php.php?error=VLAN Number already in use.");
    exit;
}
...
$query = mysqli_query($connect,$query);
if(mysqli_num_rows($query) > 0){
    header("Location: ../vlanManagement.php.php?error=VLAN Name already in use.");
    exit;                                                                                                                                                                                                                                                                                                                                        
}
...
header("Location: ../vlanManagement.php.php");
