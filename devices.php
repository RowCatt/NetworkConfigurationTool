...
<body>
    ...
    <div class="container">
        ...
        echo "<a style='margin: 15px;' class='btn btn-success' href='add_device.php'> Add New Device </a>";
        echo "<a style='margin: 15px;' class='btn btn-success' href='global_config.php'> Edit Global Configuration </a>";
                ...
                echo "<tbody>";
                        ...
                        while($currentDevice = mysqli_fetch_assoc($query))
                        {
                            ...
                            echo "<tr style='background-color: rgba($online_colour, 0.5);'>";
                                ...
                                echo "<td>";
                                    if($online == 0){
                                        echo "<a style='margin: 15px;' class='btn btn-success' href='remove_device.php?id=$id'> Remove Device </a>";
                                    }else{
                                        echo "<a style='margin: 15px;' class='btn btn-success' href='edit_device_config.php?id=$id'> Edit Configuration </a>";
                                        echo "<a style='margin: 15px;' class='btn btn-success' href='remove_device.php?id=$id'> Remove Device </a>";
                                    }
                                echo "</td>";
                            echo "</tr>";
